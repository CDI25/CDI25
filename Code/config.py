...
# weer few: learning_rate=1e-2 skip_training=1e-7 ; huge: learning_rate=1e-2 reg_learning_rate=1e-7  epoch=200  skip_training=1e-7
# imu few: learning_rate=1e-2 skip_training=1e-7 ; huge: learning_rate=1e-2 reg_learning_rate=1e-7  epoch=100  skip_training=1e-7
